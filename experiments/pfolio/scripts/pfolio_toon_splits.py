...
# load dataset
dataset_df = pd.read_csv(f"../data/pfolio_ast_formats_train.csv")
...
dev.to_csv(f"../data/pfolio_ast_formats_train.csv", index=False)
print(f"Generated gold TOON dataset for train split.")
val.to_csv(f"../data/pfolio_ast_formats_val.csv", index=False)
print(f"Generated gold TOON dataset for val split.")
test.to_csv(f"../data/pfolio_ast_formats_test.csv", index=False)
print(f"Generated gold TOON dataset for test split.")